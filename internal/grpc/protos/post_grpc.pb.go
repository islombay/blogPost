...
type PostServiceClient interface {
	Create(ctx context.Context, in *CreatePostBody, opts ...grpc.CallOption) (*Post, error)
...
func (c *postServiceClient) Create(ctx context.Context, in *CreatePostBody, opts ...grpc.CallOption) (*Post, error) {
	out := new(Post)
...
func (c *postServiceClient) GetAll(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetAllResponse, error) {
...
type PostServiceServer interface {
	Create(context.Context, *CreatePostBody) (*Post, error)
...
func (UnimplementedPostServiceServer) Create(context.Context, *CreatePostBody) (*Post, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedPostServiceServer) GetAll(context.Context, *empty.Empty) (*GetAllResponse, error) {
...
func _PostService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).Create(ctx, req.(*CreatePostBody))
	}
...
func _PostService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).GetAll(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
